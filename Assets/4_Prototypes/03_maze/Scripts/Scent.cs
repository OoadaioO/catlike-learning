...
public struct Scent {
    private NativeArray<float> scentA, scentB;
    private bool useA;
    ...
    public Scent(Maze maze) {
        ...
        scentB = new NativeArray<float>(
            maze.Length, Allocator.Persistent
        );
        useA = false;
        cooldown = 0f;
    }
    ...
    public NativeArray<float> Desperse(Maze maze, Vector3 playerPosition) {
