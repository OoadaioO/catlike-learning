...
namespace custom.render.pipeline {
    public class Shadows {
        ...
        const int maxShadowedDirectionalLightCount = 4, maxCascade = 4;
        ...
        ShadowedDirectinoalLight[] ShadowedDirectionalLights = new ShadowedDirectinoalLight[maxShadowedDirectionalLightCount];
        ...
        void RenderDirectionalShadows(int index, int split, int tileSize) {
            ShadowedDirectinoalLight light = ShadowedDirectionalLights[index];
            ShadowDrawingSettings shadowSettings = new ShadowDrawingSettings(cullingResults, light.visibleLightIndex, BatchCullingProjectionType.Orthographic);
