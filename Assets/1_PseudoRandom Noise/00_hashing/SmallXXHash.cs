...
public readonly struct SmallXXHash4 {
    ...
    public uint4 ToUint() => accumulator;

    public static implicit operator SmallXXHash4(uint4 accumulator) => new SmallXXHash4(accumulator);
    public static implicit operator SmallXXHash4(SmallXXHash hash) => new SmallXXHash4(uint4(hash.accumulator));
    ...
    uint4 BytesA => (uint4)this & 255;
    uint4 BytesB => ((uint4)this >> 8) & 255;
    uint4 BytesC => ((uint4)this >> 16) & 255;
    uint4 BytesD => (uint4)this >> 24;
